...
public class ForkJoinPool extends AbstractExecutorService {
    ...
    static final class DefaultCommonPoolForkJoinWorkerThreadFactory
        ...
        private static final boolean INNOCUOUS_COMMON_THREADS;

        static {
            boolean useInnocuousCommonThreads = true;
            try {
                useInnocuousCommonThreads = !Boolean.getBoolean(
                        "jdk.compatibility.ForkJoinPool.DefaultCommonPoolForkJoinWorkerThreadFactory.non-innocuous-threads");
            } catch (Exception ignore) {}
            INNOCUOUS_COMMON_THREADS = useInnocuousCommonThreads;
        }
                 ...
                 new PrivilegedAction<>() {
                     public ForkJoinWorkerThread run() {
                         return System.getSecurityManager() == null ?
                             new ForkJoinWorkerThread(null, pool, true, INNOCUOUS_COMMON_THREADS):
