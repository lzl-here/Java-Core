...
class ZipFileSystem extends FileSystem {
    ...
    @SuppressWarnings("removal")
    private static final boolean DISABLE_ZIP64_EXTRA_VALIDATION = AccessController.doPrivileged(
            (PrivilegedAction<Boolean>)()-> {
                boolean result;
                String value = System.getProperty(
                        "jdk.compatibility.nio.zipfs.disableZip64ExtraFieldValidation");
                if (value == null) {
                    result = false;
                } else {
        ...
        private void readExtra(ZipFileSystem zipfs) throws IOException {
            ...
            while (off + 4 < elen) {
                ...
                if (pos + sz > elen) {        // invalid data
                    if (DISABLE_ZIP64_EXTRA_VALIDATION) {
